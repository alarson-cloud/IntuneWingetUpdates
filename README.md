Deployed As an App with these settings. App already packaged and ready to upload as Win32. Currently set to run as a task scheduler task on Monday morning at 10 AM CST and run weekly. 
